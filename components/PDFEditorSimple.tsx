                ...
                {ann.type === 'formfield' && ann.isFormField && ann.fieldType === 'text' && (
                  <input
                    ...
                    style={{
                      ...
                      fontSize: `${Math.max(Math.min((ann.fontSize || 12) * pageScale, (ann.height * pageScale) * 0.45), 8)}px`,
                      color: '#000000',
                      fontWeight: 'normal',
                      padding: ann.groupId ? '1px 1px' : '2px 4px',
                      ...
                      textOverflow: 'clip',
                      whiteSpace: 'nowrap',
                      lineHeight: `${ann.height * pageScale}px`,
                  ...
                  >
                    <input
                      ...
                      style={{
                        ...
                        outline: 'none',
                        backgroundColor: 'transparent',
                        fontSize: `${Math.min((ann.fontSize || 14) * pageScale, (ann.height * pageScale) * 0.45)}px`,
                        color: ann.textColor || '#000',
                        fontWeight: 'normal',
                        padding: '2px 4px',
                        boxSizing: 'border-box',
