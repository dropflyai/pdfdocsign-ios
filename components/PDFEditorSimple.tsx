                ...
                {ann.type === 'formfield' && ann.isFormField && ann.fieldType === 'text' && (
                  <input
                    ...
                    style={{
                      ...
                      textOverflow: 'clip',
                      whiteSpace: 'nowrap',
                      lineHeight: `${Math.max(ann.height * pageScale, 7)}px`,
                      display: 'flex',
                      alignItems: 'center',
                ...
                {ann.type === 'formfield' && ann.isFormField && ann.fieldType === 'checkbox' && (
                  <div
                    ...
                    style={{
                      ...
                      pointerEvents: 'auto',
                      zIndex: 10000,
                      fontSize: `${Math.max(Math.min(ann.height * pageScale * 0.7, 20), 12)}px`,
                      fontWeight: 'bold',
                      color: '#000000',
                      lineHeight: '1',
                      userSelect: 'none',
                  ...
                  >
                    <input
                      ...
                      style={{
                        ...
                        outline: 'none',
                        backgroundColor: 'transparent',
                        fontSize: `${Math.max(Math.min((ann.fontSize || 14) * pageScale, (ann.height * pageScale) * 0.65), 9)}px`,
                        color: ann.textColor || '#000',
                        fontWeight: 'normal',
                        padding: '1px 2px',
                        boxSizing: 'border-box',
